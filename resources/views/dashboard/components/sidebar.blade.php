...
<div class="sidebar h-screen overflow-y-auto no-scrollbar bg-white w-64 space-y-6 py-1 px-2 absolute inset-y-0 left-0 top-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
    ...
    <ul class="flex px-4 md:px-3 flex-col mt-1 gap-1 lg:gap-1" >  
        ...
        <a href="/admin/kelas">
            <li class="{{ (request()->is('admin/kelas*'))  ? 'bg-sky-500 text-white' : 'bg-white text-slate-500' }} flex gap-2 cursor-pointer py-1 md:py-2 md:px-3 lg:py-3 hover:bg-sky-500  rounded-md group">
                <svg xmlns="http://www.w3.org/2000/svg" class=" h-5 w-5 lg:h-6 lg:w-6 group-hover:text-white" viewBox="0 0 20 20" fill="currentColor">
        ...
        <a href="/admin/register">
            <li class="{{ (request()->is('admin/register*'))  ? 'bg-sky-500 text-white' : 'bg-white text-slate-500' }} flex gap-1 cursor-pointer py-1 md:py-2 md:px-3 lg:py-3 hover:bg-sky-500  rounded-md group">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 lg:h-6 lg:w-6  group-hover:text-white" viewBox="0 0 20 20" fill="currentColor">
        ...
        <a href="/admin/akun">
            <li class="{{ (request()->is('admin/akun*'))  ? 'bg-sky-500 text-white' : 'bg-white text-slate-500' }} flex gap-2 cursor-pointer py-1 md:py-2 md:px-3 lg:py-3 hover:bg-sky-500  rounded-md group">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 lg:h-6 lg:w-6  group-hover:text-white" viewBox="0 0 20 20" fill="currentColor">
