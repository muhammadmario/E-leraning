    ...
    <div class="overflow-auto rounded-lg shadow">
        <table class="table-auto w-full">
            ...
            <tbody> 
                ...
                <tr>
                    <td class="p-3 ">
                        <img src="{{ asset('storage/'.$class->image) }}" alt="{{ $class->name }}" class="h-24 aspect-[4/3]">
                    </td>
                    <td class="p-3 text-sm text-gray-700">{{ $class->name }}</td>
                    <td class="p-3 text-sm text-gray-700 flex gap-2">
                        <a href="/dashboard/kelas/{{ $class->id }}" >
                        ...
                        <a href="/dashboard/kelas/{{ $class->id }}/edit">
                        ...
                        <form action="/dashboard/kelas/{{ $class->id }}" method="POST">
                            @method('delete')
                            @csrf
