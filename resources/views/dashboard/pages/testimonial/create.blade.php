...
<div class="flex-1 px-2 md:px-3 mt-14 md:mt-0 bg-indigo-50 min-h-screen pt-2">
    ...
    <form id="fileUploadForm" method="POST" action="/dashboard/testimonial" enctype="multipart/form-data" class="md:w-2/3 w-full m-auto">
        @csrf
        {{-- nama testimonial --}}
        ...
        <label for="body"  class="tracking-wide text-sm font-medium ">Kata-kata</label>
