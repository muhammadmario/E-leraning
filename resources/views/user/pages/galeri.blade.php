...
<div class="flex flex-col">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-2 gap-1 md:gap-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
    ...
    <div>
      <img  src="{{ asset('storage/'.$gallery->image) }}" alt="{{ $gallery->name }}" class="img-gallery cursor-pointer aspect-[5/3] relative h-15 group overflow-hidden hover:scale-95 transition-all duration-500 rounded-lg">
      <h1 class="font-semibold capitalize">{{ $gallery->name }}</h1>
