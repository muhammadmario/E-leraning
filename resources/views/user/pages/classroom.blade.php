...
<div class="flex flex-col">
   <div class="flex justify-center mt-3">
      <div class="w-full px-2 md:px-0 md:w-1/2">
        <form class="input-group relative flex flex-wrap items-stretch w-full mb-4" action="/kelas">
   ...
   <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-2 gap-2 mx-2">
      @foreach ($classes as $class)
      <a href="/kelas/{{ $class->slug }}" class="aspect-[5/3] relative h-15 group overflow-hidden hover:scale-95 transition-all duration-500 rounded-lg">
